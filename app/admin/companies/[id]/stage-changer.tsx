...
import { changeSalesStageAction, changeConsultingStageAction } from "./actions";
...
export function StageChanger({ companyId, currentSalesStage, currentConsultingStage }: Props) {
